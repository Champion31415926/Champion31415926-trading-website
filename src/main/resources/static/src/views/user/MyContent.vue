  ...
  methods: {
    ...
    async fetchFreshData() {
      try {
        ...
        this.$message.error("Failed to get content list");
      }
    },

    confirmDelete(content) {
      this.$confirm("Are you sure you want to delete this content? It cannot be recovered after deletion", "Confirm Deletion", {
