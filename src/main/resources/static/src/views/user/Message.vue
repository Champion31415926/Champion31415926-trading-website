  ...
  <div class="notification-container">
    ...
    <div class="notification-list">
      ...
      <div v-if="messageList.length === 0" class="empty-state">
        <el-empty description="No message notifications"></el-empty>
      </div>
    </div>
  </div>
</template>
  ...
  methods: {
    async messageIsRead() {
      try {
        ...
        console.error("Exception setting messages as read: ", error);
      }
    },
    ...
    async fetchMessage() {
      try {
        ...
        console.error("Exception querying messages: ", error);
      }
    },
    ...
    async deleteMessage(message, index) {
      try {
        await this.$confirm('Are you sure you want to delete this message?', 'Confirm Deletion', {
